  ...
  const serviceCards = [
    {
      ...
      text: "We create data-driven marketing plans that maximize reach, engagement and conversions across all channels.",
    },
    {
      id: 2,
      icon: <FaThLarge className="text-5xl text-red-500 mb-4" />,
      title: "Social Media Management",
      text: "We manage your social platforms with engaging content, campaigns and analytics to grow your audience.",
    },
    {
      id: 3,
      icon: <FaFileAlt className="text-5xl text-red-500 mb-4" />,
      title: "Brand Identity & Design",
      text: "We design strong brand identities, from logo to visual language, ensuring consistency and recognition.",
    },
    {
      id: 4,
      icon: <FaShieldAlt className="text-5xl text-red-500 mb-4" />,
      title: "SEO & Content Marketing",
      text: "We optimize websites and create high-value content that improves search rankings and drives organic traffic.",
    },
  ];
  ...
  return (
    <section className=" text-white min-h-screen">
      ...
      <div className="relative w-full min-h-[60vh] flex flex-col md:flex-row items-center  gap-10  py-20">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-4">
            ...
            <span className="text-red-500"> Business Forward</span>
          </h1>
          <p className="text-gray-400 text-lg">
            Our marketing strategies increase visibility, attract customers and
            build a brand that people trust and remember.
          </p>
          <motion.button
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-16 py-20">
        ...
        >
          Marketing & Branding <span className="text-red-500">Expertise</span>
        </motion.h2>
